...
pub.characterStyle = function(name) {
  var style = null || findInCollectionByName(name);
 ...
 */
pub.paragraphStyle = function(name, props) {
  var style = findInCollectionByName(name) || null;
  var properties = props || {};
  properties.name = name;
  alert( typeof style );
  // if(typeof style === 'undefined'){
    style = currentDoc().paragraphStyles.add( properties );
  // }
  for( var key in properties ) $.writeln( key + ': ' + properties[key] );
